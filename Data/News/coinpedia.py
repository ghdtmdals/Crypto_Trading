...
class CoinPedia:
    ...
    def get_news_data(self) -> dict:
        ...
        coinpedia_news = soup.find_all('div', "post-details")
    ...
    def get_date(self, soup) -> datetime.datetime:
        ### 날짜 가져오기
        date = soup.find('span', "date meta-item tie-icon").text
    ...
    def save_data(self) -> None:
        ...
        file_path = f"./Database/{self.coin_name}_coinpedia.json"
