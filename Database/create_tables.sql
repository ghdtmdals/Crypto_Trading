...
CREATE TABLE IF NOT EXISTS Trade_Log (
	...
	krw_balance INT(10) NOT NULL,
	token_balance DECIMAL(10, 8) NOT NULL,
...
CREATE TABLE IF NOT EXISTS Upbit (
	...
	opening_price DECIMAL(12, 3) NOT NULL,
	trade_price DECIMAL(12, 3) NOT NULL,
	signed_change_rate DECIMAL(8, 6) NOT NULL,
